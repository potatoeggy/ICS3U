	...
	public static void main(String[] args) {
		...
		while (exit != 1) { // main menu loop
			...
			if (menuSelect == 1) {
				...
				// add new student
				if (filled == 100) {
					System.out.println("Maximum number of students reached. Please remove a student first."); // handle too many students
				} else {
					...
					System.out.print("Mark " + (filled + 1) + ": ");
